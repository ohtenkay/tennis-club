...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        val c1 = courtService.createCourt(new CourtSend(st1.getId(), "Court 1", "Regular court"));
        val c2 = courtService.createCourt(new CourtSend(st1.getId(), "Court 2", "More regular court"));
        val c3 = courtService.createCourt(new CourtSend(st2.getId(), "Court 3", "Synthetic court"));
        val c4 = courtService.createCourt(new CourtSend(st2.getId(), "Court 4", "Synthetic court, but bigger"));
